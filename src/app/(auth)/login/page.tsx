            ...
            <div className="animate-in flex-1 flex flex-col w-full justify-center gap-2 text-foreground">
                ...
                <form>
                    <button
                        ...
                        className="w-full bg-btn-background hover:bg-btn-background-hover text-foreground font-medium rounded-md px-4 py-2 border flex items-center justify-center gap-2"
                    >
